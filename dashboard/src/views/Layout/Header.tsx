...
import { getBaseUrl, isEmpty, serverError } from "@utils/Utils";
...
import { getNavigate, setNavigate } from "@utils/Global";
...
const Header: React.FC<Header> = ({
  ...
  // location.pathname == "/search/serachResult"
  //   ? setNavigate(location.pathname + location.search)
  //   : "";
        ...
        >
          ...
          >
            ...
            <Stack direction="row" alignItems="center" gap="0.25rem">
              <LightTooltip title="Display All Files">
                <AntSwitch
                  sx={{ marginRight: "4px" }}
                  size="small"
                  // checked={checked}
                  ...
                  <List dense disablePadding>
                    <ListItem dense disablePadding>
                      ...
                      >
                        ...
                        {/* <Link
                          to={{
                            pathName: downloadSearchResultsCSVUrl(file.fileName)
                          }}
                        > */}
                        <IconButton
                          color="success"
