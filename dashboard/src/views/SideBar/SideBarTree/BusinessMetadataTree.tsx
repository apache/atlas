...
const BusinessMetadataTree = (props: Props) => {
  ...
  const [businessMetaDataLoader, setBusinessMetadataDataLoader] =
    useState<boolean>(false);

  useEffect(() => {
    setBusinessMetadataDataLoader(true);
    dispatch(fetchBusinessMetaData());
    setBusinessMetadataDataLoader(false);
  }, []);
