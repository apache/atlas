...
const CustomContent = forwardRef(function CustomContent(
  ...
  return (
    <CustomContentRoot
      ...
      selectedNodeTerm={labelProps?.selectedNodeTerm}
      selectedNodeCustomFilter={labelProps?.selectedNodeCustomFilter}
          ...
          label={
            <HoverableTreeItemContainer
              {...({
                ...
                selectedNodeTerm: selectedNode.term ? selectedNode.term.split("@")[0] : null,
                selectedNodeCustomFilter: selectedNode.customFilter,
                node: treeName === "Classifications" && node.label ? node.label.split(" (")[0] : node.id,
