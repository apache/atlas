...
const payloadFromBarEvent = (
  item: unknown,
): EntityTypeDistributionItem | undefined => {
...
const EntityTypeBarChart = memo(
  ({ entity, typeHeaderData, isLoading }: EntityTypeBarChartProps) => {
      ...
      return (
        <Box className="classification-distribution-card__tooltip">
          ...
          <Typography
            variant="caption"
            display="block"
            className="entity-type-bar-chart__tooltip-deleted"
          >
    ...
    return (
      <Paper elevation={1} className="entity-type-bar-chart__paper">
        <Box className="classification-distribution-card__header">
          ...
          >
            ...
            <Link
              ...
              className="entity-type-bar-chart__view-all-link"
          ...
          <Box className="classification-distribution-card__chart-container">
            ...
            >
              <Stack direction="row" alignItems="center" spacing={0.75}>
                <Box
                  className="entity-type-bar-chart__legend-color-active"
                  aria-hidden
                />
                <Typography
                  variant="caption"
              ...
              <Stack direction="row" alignItems="center" spacing={0.75}>
                <Box
                  className="entity-type-bar-chart__legend-color-deleted"
                  aria-hidden
                />
                <Typography
                  variant="caption"
              ...
              >
                  ...
                  tick={(props: Record<string, unknown>) => {
                    ...
                    return (
                      <g
                        ...
                        className="classification-distribution-card__y-axis-tick"
                ...
                >
                  <LabelList
                    ...
                    className="entity-type-bar-chart__x-axis-tick"
                  />
                  {data.map((_, index) => (
