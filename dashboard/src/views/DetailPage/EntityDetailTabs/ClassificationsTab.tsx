...
const ClassificationsTab: React.FC<EntityDetailTabProps> = ({
  ...
  const handleRemove = async () => {
    try {
      await removeClassification(entity.guid, currentValue.selectedValue);
      if (!isEmpty(guid)) {
    ...
    () => [
      {
        ...
        cell: (info: any) => {
          ...
          if (entity.guid != info.row.original.entityGuid) {
            return (
                  ...
                  <Chip
                    ...
                    label={
                      <Link
                        ...
                        color={"primary"}
                      >
                        <EllipsisText>Proagated From</EllipsisText>
                      </Link>
                    }
                    variant="outlined"
                    size="small"
