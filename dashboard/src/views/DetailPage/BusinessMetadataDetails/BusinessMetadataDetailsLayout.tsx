...
import { defaultAttrObj } from "@utils/Enum";
    ...
    let attributes = attributeDefsData.map((item) => {
      ...
      return {
        ...
        ...{
          ...
          searchWeight: rest.searchWeight,
          typeName: multiValueSelect ? `array<${rest.typeName}>` : rest.typeName
        }
      };
    });
                    ...
                    {isEmpty(bmAttribute) && (
                      <Grid item md={6}>
                        <Stack marginBottom="1rem">
                          <LightTooltip
                            title={"Add Business Metadata ttribute"}
                          >
                            <CustomButton
                              sx={{
