...
const ClassificationForm = ({
  ...
  const onSubmit = async (data: any) => {
    ...
    if (isAdd) {
      ...
      val["superTypes"] = classifications.map(
      ...
      val["attributeDefs"] = attributes.map((obj) => {
        const newObj = {
          ...attributesObj,
          ...{ cardinality: obj.toggleDuplicates ? "LIST" : "SET" }
        };

        newObj.name = obj.attributeName;
        newObj.typeName = !isEmpty(obj.typeName) ? obj.typeName : "string";
