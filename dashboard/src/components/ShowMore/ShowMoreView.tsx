...
import { Typography, Chip, Link as MuiLink, IconButton } from "@mui/material";
                ...
                <Chip
                  ...
                  deleteIcon={
                    isDeleteIcon && obj.count > 1 ? (
                      ...
                      >
                        <Typography color="white"> {`${obj.count}`}</Typography>
                      </IconButton>
                    ) : undefined
                  }
                  component="a"
        ...
        >
          <Typography fontSize={14}>
            ...
            <Typography
              ...
              sx={{ fontWeight: 600 }}
            >
              {!isEmpty(currentEntity) ? `${currentValue.assetName} ` : ""}
            </Typography>{" "}
            ?
          </Typography>
        </CustomModal>
