...
public class SecureEmbeddedServer extends EmbeddedServer {
    ...
    public static final String DEFAULT_KEYSTORE_FILE_LOCATION = "conf/metadata.keystore";
    public static final String KEYSTORE_PASSWORD_KEY = "keystore.password";
    public static final String TRUSTSTORE_FILE_KEY = "truststore.file";
    public static final String DEFATULT_TRUSTORE_FILE_LOCATION = "conf/metadata.keystore";
