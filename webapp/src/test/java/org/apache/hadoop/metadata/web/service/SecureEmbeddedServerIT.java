...
public class SecureEmbeddedServerIT {
    ...
    public void testNoConfiguredCredentialProvider() throws Exception {
        ...
        try {
            ...
            webapp.setWar(System.getProperty("user.dir") + "/target/metadata-governance.war");
    ...
    public void runOtherSuitesAgainstSecureServer() throws Exception {
        ...
        testng.setTestClasses(new Class[] { EntityJerseyResourceIT.class,
                MetadataDiscoveryResourceIT.class, RexsterGraphJerseyResourceIT.class, TypesJerseyResourceIT.class});
