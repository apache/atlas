...
/**
 * Test class for QuickStart
 * <p>
 * This test class provides focused coverage for the QuickStart class,
 * testing all public methods with key scenarios to achieve high code coverage.
 */
...
//            mockedTypesUtil.verify(() -> TypesUtil.createClassTypeDef(anyString(), anyString(), any(), any(AttributeDefinition.class)), atLeastOnce());
//            mockedTypesUtil.verify(() -> TypesUtil.createTraitTypeDef(anyString(), anyString(), any()));
        }
    }
