...
public class DebugMetricsWrapperTest {
    ...
    public void testInit() throws Exception {
        ...
        // Since we can't easily mock static methods, we'll test that init doesn't throw exceptions
    ...
    public void testUpdate() throws Exception {
        ...
        // Verify that the update method was called (we can't easily verify the internal state)
