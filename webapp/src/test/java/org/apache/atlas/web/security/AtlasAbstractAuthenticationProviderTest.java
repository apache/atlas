...
/**
 * Test class for AtlasAbstractAuthenticationProvider
 * <p>
 * This test class provides comprehensive coverage for the AtlasAbstractAuthenticationProvider class,
 * testing all public and protected methods with various scenarios to achieve 100% code coverage.
 */
public class AtlasAbstractAuthenticationProviderTest {
    ...
    public void testGetAuthoritiesFromUGI_WithNullUgi() {
        ...
        try (MockedStatic<UserGroupInformation> mockedUgi = mockStatic(UserGroupInformation.class);
            ...
            // Verify - should return authorities (may be empty or contain groups from Hadoop Groups)
            assertNotNull(authorities);

            mockedUgi.verify(() -> UserGroupInformation.createRemoteUser(userName));
            // AuthenticationUtil.includeHadoopGroups() may or may not be called depending on execution path
        }
    }
    ...
    public void testGetAuthoritiesFromUGI_WithIncludeHadoopGroupsTrue() {
        ...
        try (MockedStatic<UserGroupInformation> mockedUgi = mockStatic(UserGroupInformation.class);
            ...
            // Verify - should include UGI groups and potentially Hadoop groups
            assertNotNull(authorities);
    ...
    public void testGetAuthoritiesFromUGI_WithNullUserName() {
        try {
            ...
            // IllegalArgumentException is acceptable behavior for null user
    ...
    public void testGetAuthoritiesFromUGI_WithEmptyUserName() {
        try {
            ...
            // Verify - should handle empty string gracefully
            assertNotNull(authorities);
        } catch (IllegalArgumentException e) {
