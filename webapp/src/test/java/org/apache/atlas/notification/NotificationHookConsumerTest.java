...
public class NotificationHookConsumerTest {
    ...
    public void testHookConsumerCreateOrUpdateWithBatching() throws Exception {
        ...
        // Should be called 3 times (12/5 = 2 full batches + 1 partial batch of 2)
    ...
    public void testHookConsumerCreateOrUpdateWithPostUpdateEntities() throws Exception {
        ...
        // Should be called twice - once for main entities, once for post-update entities
    ...
    public void testHookConsumerMaxRetriesWithFailedMessageRecording() throws Exception {
        ...
        // Should record failed messages when cache is fullverify(notificationConsumer, never()).commit(any(TopicPartition.class), anyLong()); // Should not commit failures
    }
    ...
    public void testHookConsumerHandleUnrecoverableFailure() throws Exception {
        ...
        // Should only try once (no retries for unrecoverable failures)verify(notificationConsumer, never()).commit(any(TopicPartition.class), anyLong());
    }
    ...
    // HookConsumer Comprehensive Tests
...
//        verify(notificationConsumer, never()).commit(any(TopicPartition.class), anyLong());
    }
    ...
    public void testHookConsumerHandleMessageWithInvalidMessageObject() throws Exception {
        ...
        // Use ENTITY_CREATE type but NOT an actual EntityCreateRequest
    ...
    public void testHookConsumerHandleMessageWithInterruptedException() throws Exception {
        ...
        try {
            ...
            // Expected due to InterruptedException
        }
    }
