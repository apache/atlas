...
public class AtlasDiscoveryServiceTest extends BasicTestSetup {
    ...
    @Test
    public void testSearchRelatedEntitiesWithDisableDefaultSorting() throws AtlasBaseException {
        String           guid   = gethiveTableSalesFactGuid();
        SearchParameters params = new SearchParameters();
        ...
        AtlasSearchResult unsortedResult = discoveryService.searchRelatedEntities(
        ...
        // Test 2: With disableDefaultSorting=false (default name sorting applied)
        AtlasSearchResult sortedResult = discoveryService.searchRelatedEntities(
        ...
        assertEquals(unsortedGuids, sortedGuids, "Both methods should return same entities");
    }
    ...
    @Test
    public void testSearchRelatedEntitiesWithDeletedEntities() throws AtlasBaseException {
        String           guid   = gethiveTableSalesFactGuid();
        SearchParameters params = new SearchParameters();
