...
/**
 * C5.4 integration test: Atlas aggregations via Testcontainers OpenSearch.
 */
public class OpenSearchAggregationsIT extends OpenSearchITBase {

    @Test
    public void aggregationsValidation() throws Exception {
        assertTrue(OpenSearchAggregationsValidationDriver.execute(), "C5.4 aggregations validation failed");
    }
}
