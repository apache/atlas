...
/**
 * Unit test class for AtlasAbstractFormatConverter.
 * Tests the abstract base class functionality including type validation and type category retrieval.
 */
public class AtlasAbstractFormatConverterTest {
    ...
    public void testIsValidValueV1WithNullType() {
        ...
        // When/Then - This should handle gracefully even with null type
        try {
    ...
    /**
     * Concrete test implementation of AtlasAbstractFormatConverter for testing purposes.
     * Since AtlasAbstractFormatConverter is abstract, we need a concrete implementation
