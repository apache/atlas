...
/**
 * Unit test class for TypeConverterUtil.
 * Tests type definition conversion utilities between V1 and V2 Atlas models.
 */
public class TypeConverterUtilTest {
    ...
    public void testPrivateConstructor() throws Exception {
        // Test that the private constructor works (for code coverage)
    ...
    public void testToAtlasTypesDefWithComplexEnumJson() throws AtlasBaseException {
        ...
        assertNotNull(result);
        assertNotNull(result.getEnumDefs());
        // Should successfully parse the enum definitions
    }
