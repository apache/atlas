...
public class RelationshipCacheGeneratorTest {
    ...
    public void createLookup() {
        final String processInputKey  = "__Process.inputs";
        final String processOutputKey = "__Process.outputs";
        ...
        assertEquals(cache.get(processInputKey).getTypeName(), "dataset_process_inputs");
        assertEquals(cache.get(processInputKey).getPropagateTags(), TWO_TO_ONE);

        assertEquals(cache.get(processOutputKey).getTypeName(), "process_dataset_outputs");
        assertEquals(cache.get(processOutputKey).getPropagateTags(), ONE_TO_TWO);
    }
