...
/**
 * Comprehensive test class for SearchResultDownloadTaskFactory targeting 90%+ coverage
 */
public class SearchResultDownloadTaskFactoryTest {
    ...
    // Helper methods
    private void invokeCleanupMethod(SearchResultDownloadTaskFactory factory) throws Exception {
        Method cleanupMethod = SearchResultDownloadTaskFactory.class.getDeclaredMethod("cleanupExpiredFiles");
        cleanupMethod.setAccessible(true);
        cleanupMethod.invoke(factory);
    }
