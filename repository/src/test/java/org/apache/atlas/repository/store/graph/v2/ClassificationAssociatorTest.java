...
public class ClassificationAssociatorTest {
    ...
    private static final String TEST_FILES_SUBDIR     = "classification-association";
    ...
    public void updaterTests() throws IOException {
        ...
        updaterAssert("header-PII", "col-entity-PII", PROCESS_UPDATE + ":PII");
        updaterAssert("header-None", "col-entity-PII", PROCESS_DELETE + ":PII");
        updaterAssert("header-PII-VENDOR_PII", "col-entity-PII-FIN_PII", PROCESS_DELETE + ":FIN_PII", PROCESS_UPDATE + ":PII", PROCESS_ADD + ":VENDOR_PII");
        updaterAssert("header-None", "col-entity-None");
        updaterAssert("header-FIN_PII", "col-entity-PII", PROCESS_DELETE + ":PII", PROCESS_ADD + ":FIN_PII");
    }

    @Test
    public void updater_filterPropagatedClassifications() throws IOException {
        updaterAssert("header-Tx-prop-T1", "col-entity-T1-prop-Tn", PROCESS_DELETE + ":T1", PROCESS_ADD + ":Tx");
        updaterAssert("header-Tx-prop-T1-No-Guid", "col-entity-T1-prop-Tn-No-Guid", PROCESS_DELETE + ":Tn", PROCESS_UPDATE + ":T1", PROCESS_ADD + ":Tx");
    }

    private AtlasEntityHeaders setupRetriever(String headersFile, int fromTimestamp, int toTimestamp, final String tableGuid) {
        AtlasEntityHeader entityHeaderWithClassification;
