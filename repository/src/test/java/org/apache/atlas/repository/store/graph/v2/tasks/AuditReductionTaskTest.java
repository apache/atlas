...
/**
 * Comprehensive test class for AuditReductionTask targeting 90%+ coverage
 */
public class AuditReductionTaskTest {
    ...
    public void testPerformWithException() throws Exception {
        ...
        // Mock findVertex to throw exception
    ...
    public void testRunWithLargeBatchOfGuids() throws Exception {
        ...
        // Create large list of guids (more than batch size)
