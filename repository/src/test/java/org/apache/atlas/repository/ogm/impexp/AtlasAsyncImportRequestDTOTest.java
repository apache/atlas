...
public class AtlasAsyncImportRequestDTOTest {
    ...
    public void testObjectToLongWithInvalidString() throws Exception {
        ...
        try {
            ...
            // The method should handle NumberFormatException internally but if reflection causes issues
            // we can check that the underlying cause is NumberFormatException
