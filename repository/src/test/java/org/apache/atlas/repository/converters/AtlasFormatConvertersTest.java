...
/**
 * Unit test class for AtlasFormatConverters.
 * Tests the converter registry functionality including registration and retrieval of converters.
 */
public class AtlasFormatConvertersTest {
    ...
    public void testGetConverterForUnknownType() throws AtlasBaseException {
        // Given - a type category that doesn't exist in the enum or is unmapped
        // Create a mock unknown type category by using reflection or a different approach
        // For now, we'll use an existing category that should fail
    ...
    public void testEntityConverterRegisteredForObjectIdType() throws Exception {
        ...
        registryField.setAccessible(true);
        Map<TypeCategory, AtlasFormatConverter> registry = (Map<TypeCategory, AtlasFormatConverter>) registryField.get(formatConverters);
        // Verify that ENTITY and OBJECT_ID_TYPE point to different converter instances
        // due to registration order - ObjectIdConverter overwrites EntityConverter for OBJECT_ID_TYPE
    ...
    public void testConstructorWithMockRegistry() {
        // Given - Create a new instance to test constructor behavior
    ...
    public void testRegistrationWithMockedConverters() {
        // Test the registration behavior by mocking converter construction
    ...
    public void testGetConverterPerformance() throws AtlasBaseException {
        // Test that converter retrieval is fast (should be O(1) HashMap lookup)
        ...
        // Should complete in reasonable time (less than 100ms for 3000 lookups)
