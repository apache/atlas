...
/**
 * Comprehensive test class for AuditReductionEntityRetrievalTask targeting 90%+ coverage
 */
public class AuditReductionEntityRetrievalTaskTest {
    ...
    public void testPerformWithEmptyParameters() throws Exception {
        ...
        // Note: setStatus(FAILED) is not called when perform() returns early
    }
    ...
    public void testPerformWithException() throws Exception {
        ...
        // The exception is caught in run() method and logged, perform() should complete normally
        AtlasTask.Status result = retrievalTask.perform();
    ...
    public void testValidateTypesForDefaultAgingTypeWithInvalidTypes() throws Exception {
        ...
        assertTrue(result); // For DEFAULT aging type, invalid types are allowed
    }
