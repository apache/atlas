...
public class PurgeServiceTest extends AtlasTestBase {
    ...
    @Test
    public void testPurgeEntitiesWithNoDeletionCandidates() throws Exception {
    ...
    @Test
    public void testPurgesSingleCandidate() throws Exception {
    ...
    @Test
    public void testShutsDownWorkersWhenSoftDeleteHasNoResults() throws Exception {
    ...
    @Test
    public void testLaunchesCleanupWhenSoftDeleteEnabled() throws Exception {
    ...
    @Test
    public void testDoesNotLaunchCleanupWhenSoftDeleteDisabled() throws Exception {
        PurgeService spy = Mockito.spy(new PurgeService(atlasGraph, entityStore, typeRegistry));
