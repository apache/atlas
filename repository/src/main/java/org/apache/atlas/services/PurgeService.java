...
public class PurgeService implements Service {
        ...
        protected void attemptCommit() {
            ...
            try {
                if (isPurgeEnabled) {
                    ...
                    res = entityStore.schedulePurgeEntities(batch);
                } else {
    ...
    private int getPurgeRetentionPeriod() {
        ...
        return Math.min(PURGE_RETENTION_PERIOD_DEFAULT, retentionPeriod); // for enforcing the minimum retention period  of 30 days
    }
