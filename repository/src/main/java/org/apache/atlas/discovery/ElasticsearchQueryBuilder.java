...
public class ElasticsearchQueryBuilder {
    ...
    QueryBuilder getMatchAllQueryBuilder(String searchText, Map<String, Float> fieldsWithBoostVal) {
        QueryBuilder queryBuilder = QueryBuilders.multiMatchQuery(searchText)
                .fields(fieldsWithBoostVal)
                .fuzziness(Fuzziness.AUTO);
        return queryBuilder;
    }

    SearchSourceBuilder getSourceBuilder(QueryBuilder queryBuilder) {
