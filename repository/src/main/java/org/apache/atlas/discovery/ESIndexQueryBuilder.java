...
public class ESIndexQueryBuilder {
    ...
    void constructSearchSource(SearchSourceBuilder sourceBuilder, String queryString,
        ...
        if (fullTextQuery != null) {
            ...
            fullTextQueryBuilder.fields().put(Atlan_ENTITY_TYPE + ".integrationType", 100F);
            fullTextQueryBuilder.fields().put(ASSET_ENTITY_TYPE + ".__s_name", 50F);
            fullTextQueryBuilder.fields().put(Atlan_ENTITY_TYPE + ".displayName", 50F);
            ...
            fullTextQueryBuilder.fields().put(Atlan_ENTITY_TYPE + ".status", 5F);
