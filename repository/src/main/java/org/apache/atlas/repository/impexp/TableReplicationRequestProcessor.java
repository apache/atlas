...
public class TableReplicationRequestProcessor {
    ...
    public void process(AtlasExportRequest exportRequest, AtlasImportRequest importRequest, String userName) throws AtlasBaseException {
    ...
    private void deleteTables(String sourceCluster, Set<String> guidsToDelete, String userName) throws AtlasBaseException {
    ...
    private void createAuditEntry(String sourceCluster, Set<String> guidsToDelete, String userName) throws AtlasBaseException {
        auditsWriter.write(userName, sourceCluster, startTstamp, endTstamp, guidsToDelete);
