...
public class EntityGraphMapper {
     ...
     * This method handles both full replace and append modes, ensuring that the __meaningsText
     * property accurately reflects the final state of meanings after additions and deletions.
     *
    ...
    void updateMeaningsTextProperty(AttributeMutationContext ctx, boolean isAppend,
        ...
        if (!isAppend) {
            ...
            handleAppendMeaningsText(ctx, newMeaningNames, deletedMeaningsNames, newMeaningsQNames, deletedMeaningsQNames);
        }
    }
