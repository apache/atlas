...
public abstract class GlossaryUtils {
    ...
    protected static final String TERM_DISPLAY_TEXT_KEY = ATLAS_GLOSSARY_TERM_TYPENAME + ".name";
    protected static final String CATEGORY_DISPLAY_TEXT_KEY = ATLAS_GLOSSARY_CATEGORY_TYPENAME + ".name";
    protected static final String CATEGORY_PARENT_EDGE_LABEL = "r:AtlasGlossaryCategoryHierarchyLink";
    protected static final String CATEGORY_TERMS_EDGE_LABEL = "r:AtlasGlossaryTermCategorization";
    protected static final String GLOSSARY_TERMS_EDGE_LABEL = "r:AtlasGlossaryTermAnchor";
    protected static final String GLOSSARY_CATEGORY_EDGE_LABEL = "r:AtlasGlossaryCategoryAnchor";
    protected static final String TERM_QUALIFIED_NAME_KEY = ATLAS_GLOSSARY_TERM_TYPENAME + ".qualifiedName";
    protected static final String CATEGORY_QUALIFIED_NAME_KEY = ATLAS_GLOSSARY_CATEGORY_TYPENAME + ".qualifiedName";
    ...
    public static AtlasEntityHeader getAtlasGlossaryEntityHeaderSkeleton(final String glossaryGuid) {
        return new AtlasEntityHeader(ATLAS_GLOSSARY_TYPENAME, glossaryGuid, null);
    }

    public static AtlasEntityHeader getAtlasCategoryEntityHeaderSkeleton(final String categoryGuid) {
        return new AtlasEntityHeader(ATLAS_GLOSSARY_CATEGORY_TYPENAME, categoryGuid, null);
    }
