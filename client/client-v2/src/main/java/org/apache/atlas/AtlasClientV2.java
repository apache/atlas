...
public class AtlasClientV2 extends AtlasBaseClient {
    ...
    public void deleteRelationshipByGuid(String guid) throws AtlasServiceException {
        callAPI(formatPathParameters(API_V2.DELETE_RELATIONSHIP_BY_GUID, guid), null, null);
    }
    ...
    public static class API_V2 extends API {
        ...
        public static final API_V2 DELETE_RELATIONSHIP_BY_GUID = new API_V2(RELATIONSHIPS_URI + "guid/%s", HttpMethod.DELETE, Response.Status.NO_CONTENT);
