...
public class AtlasClientHelper {
    ...
    public static AtlasEntityHeader getTrinoInstance(String namespace) throws AtlasServiceException {
    ...
    public static AtlasEntity.AtlasEntityWithExtInfo createOrUpdateCatalogEntity(Catalog catalog) throws AtlasServiceException {
        ...
        if (ret == null) {
            ...
            entity.setAttribute(QUALIFIED_NAME_ATTRIBUTE, catalogName + "@" + trinoNamespace);
    ...
    public static AtlasEntity.AtlasEntityWithExtInfo toTableEntity(Catalog catalog, String schema, String table, Map<String, Map<String, Object>> trinoColumns, AtlasEntity schemaEntity, AtlasEntity.AtlasEntityWithExtInfo tableEntityExt)  {
        ...
        for (Map.Entry<String, Map<String, Object>> columnEntry : trinoColumns.entrySet()) {
            ...
            String colQualifiedName = catalog.getName() + "." + schema + "." + table + "." + columnName + "@" + catalog.getInstanceName();
