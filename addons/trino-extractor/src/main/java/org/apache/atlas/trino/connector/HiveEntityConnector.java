...
public class HiveEntityConnector extends AtlasEntityConnector {
    ...
    @Override
    public void connectTrinoSchema(String instanceName, String catalogName, String schemaName, AtlasEntity dbEntity, AtlasEntity.AtlasEntityWithExtInfo entityWithExtInfo) {
    ...
    public void connectTrinoColumn(String instanceName, String schemaName, String tableName, AtlasEntity trinoColumn) throws AtlasServiceException {
        if (instanceName == null) {
            return;
        }
    ...
    private AtlasEntity toDbEntity(String instanceName, String schemaName) throws AtlasServiceException {
