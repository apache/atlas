...
/**
 * Test JVM system class loader for bridge integration tests on Java 9+ that use Hive 3.1.x.
 * {@code SessionState} casts {@code SessionState.class.getClassLoader()} to {@link URLClassLoader};
 * install via {@code -Djava.system.class.loader} in failsafe on JDK 9+.
 */
