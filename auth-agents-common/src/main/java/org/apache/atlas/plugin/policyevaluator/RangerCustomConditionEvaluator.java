...
public class RangerCustomConditionEvaluator {
    ...
    private RangerConditionEvaluator newConditionEvaluator(String className) {
        ...
        try {
            ...
            Class<org.apache.atlas.plugin.conditionevaluator.RangerConditionEvaluator> matcherClass = (Class<org.apache.atlas.plugin.conditionevaluator.RangerConditionEvaluator>)Class.forName(className);
