...
public class AtlasEntityHeader extends AtlasStruct implements Serializable {
    ...
    private List<AtlasTermAssignmentHeader> terms               = null;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(guid, that.guid) &&
                       ...
                       Objects.equals(termNames, that.classificationNames) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), guid, status, displayText, classificationNames, classifications, termNames, terms);
    }
    ...
    public void setTermNames(final List<String> termNames) {
        this.termNames = termNames;
    }

    public List<AtlasTermAssignmentHeader> getTerms() {
        return terms;
    }

    public void setTerms(final List<AtlasTermAssignmentHeader> terms) {
        this.terms = terms;
    }
