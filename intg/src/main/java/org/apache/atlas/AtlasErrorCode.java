...
public enum AtlasErrorCode {
    ...
    INVALID_DSL_QUERY_SIZE(400, "ATLAS-400-00-069", "DSL Error - Please provide query size less than {0}"),
    RELATIONSHIP_UPDATE_END_CHANGE_NOT_ALLOWED(404, "ATLAS-400-00-103", "change of relationship end is not permitted. relationship-type={0}, relationship-guid={1}, end-guid={2}, updated-end-guid={3}"),
