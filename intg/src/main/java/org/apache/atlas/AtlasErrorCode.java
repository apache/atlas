...
public enum AtlasErrorCode {
    ...
    ASYNC_INGESTION_MODE_ENABLED(503, "ATLAS-503-00-004", "Atlas is in async ingestion mode. Admin and repair operations are temporarily blocked. Disable async ingestion first."),
