...
public class AuthenticationUtilTest {
    ...
    // Note: Static method tests involving ApplicationProperties and System console
    // are omitted as they require static mocking which is not available in Mockito 1.8.5
    // These methods would need integration tests or PowerMock for complete coverage
}
