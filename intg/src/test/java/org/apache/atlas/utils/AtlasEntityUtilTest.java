...
public class AtlasEntityUtilTest {
    ...
    // Simplified metrics tests without complex data structures
    @Test
    public void testMetricsToTypeDataWithNullTypeData() {
        // Simple test that doesn't depend on complex AtlasMetrics structure
        // This tests the null check at the beginning of the method
