...
public class TestAtlasType {
    // Concrete implementation for testing the abstract AtlasType
    ...
    public void testConstructorWithTypeDef() {
        ...
        // Service type might be null for some types
    ...
    public void testIsValidValueForUpdate() {
        ...
        // Default implementation should call isValidValue
    ...
    public void testGetNormalizedValueForUpdate() {
        ...
        // Default implementation should call getNormalizedValue
    ...
    public void testValidateValueForUpdate() {
        ...
        // Default implementation should call validateValue
    ...
    public void testJsonMethodsWithEmptyString() {
        ...
        // Test fromV1Json with empty string
        try {
