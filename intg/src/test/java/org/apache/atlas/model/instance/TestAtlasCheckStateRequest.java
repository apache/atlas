...
public class TestAtlasCheckStateRequest {
    ...
    public void testRealWorldScenario() {
        // Simulate a real-world scenario where we want to check state of specific entities
        // and optionally fix issues
        AtlasCheckStateRequest request = new AtlasCheckStateRequest();
    ...
    public void testScenarioWithOnlyGuids() {
        // Test scenario where we only want to check specific entities by GUID
        AtlasCheckStateRequest request = new AtlasCheckStateRequest();
        ...
        // Don't set entity types - we only care about specific entities
        // Don't fix issues - just check
        request.setFixIssues(false);
    ...
    public void testScenarioWithOnlyTypes() {
        // Test scenario where we want to check all entities of certain types
        AtlasCheckStateRequest request = new AtlasCheckStateRequest();
        ...
        // Don't set specific guids - we want all entities of these types
        // Enable fix issues for cleanup
        request.setFixIssues(true);
