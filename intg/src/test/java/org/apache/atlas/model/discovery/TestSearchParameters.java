...
public class TestSearchParameters {
    ...
    public void testDefaultConstructor() {
        ...
        assertTrue(params.getIncludeSubTypes()); // Default is true
        assertTrue(params.getIncludeSubClassifications()); // Default is true
    ...
    public void testIncludeSubTypesGetterSetter() {
        assertTrue(searchParameters.getIncludeSubTypes()); // Default is true
    ...
    public void testIncludeSubClassificationsGetterSetter() {
        assertTrue(searchParameters.getIncludeSubClassifications()); // Default is true
    ...
    public void testSerializable() {
        // Test that SearchParameters implements Serializable
    ...
    // Tests for FilterCriteria inner class
    @Test
