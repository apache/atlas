...
public class TestAttributeTransform {
    ...
    public void testAddConditionWithEmptyAttributeName() {
        ...
        Map<String, String> conditions = attributeTransform.getConditions();
        // Should not add anything when attribute name is empty
        if (conditions != null) {
            assertTrue(conditions.isEmpty());
        }
    }
    ...
    public void testAddConditionWithNullConditionValue() {
        ...
        Map<String, String> conditions = attributeTransform.getConditions();
        // Should not add anything when condition value is null
        if (conditions != null) {
            assertTrue(conditions.isEmpty());
        }
    }
    ...
    public void testAddConditionWithEmptyConditionValue() {
        ...
        Map<String, String> conditions = attributeTransform.getConditions();
        // Should not add anything when condition value is empty
        if (conditions != null) {
            assertTrue(conditions.isEmpty());
        }
    }
    ...
    public void testAddActionWithNullAction() {
        // Ensure action map is null initially
        attributeTransform.setAction(null);
    ...
    public void testAddActionWithNullActionValue() {
        ...
        Map<String, String> action = attributeTransform.getAction();
        // Should not add anything when action value is null
        if (action != null) {
            assertTrue(action.isEmpty());
        }
    }
    ...
    public void testAddActionWithEmptyActionValue() {
        ...
        Map<String, String> action = attributeTransform.getAction();
        // Should not add anything when action value is empty
        if (action != null) {
            assertTrue(action.isEmpty());
        }
    }
    ...
    public void testSpecialCharactersInKeysAndValues() {
        String specialAttribute = "attr-с-кириллицей-字符-!@#$%^&*()";
        String specialCondition = "condition-äöü-🌟-<>{}[]";
        String specialAction = "action-éñç-∑∞√-|\\";
    ...
    public void testLargeNumberOfConditionsAndActions() {
        // Test with many conditions and actions
        for (int i = 0; i < 1000; i++) {
    ...
    public void testWhitespaceHandling() {
        // Test with strings that have leading/trailing whitespace
        ...
        // The method should treat these as valid non-empty strings
    ...
    public void testMixedEmptyAndValidValues() {
        ...
        // Try to add some invalid entries
    ...
    public void testComplexWorkflow() {
        // Simulate a complete attribute transformation workflow
        AttributeTransform transform = new AttributeTransform();
        ...
        // Test overwriting existing condition/action
    ...
    public void testIndependentConditionsAndActions() {
        // Test that conditions and actions can have different keys
    ...
    public void testSettersAfterAddMethods() {
        // Add some conditions and actions using add methods
        attributeTransform.addCondition("attr1", "cond1");
        attributeTransform.addAction("attr1", "action1");

        // Override with setters
        ...
        // Verify that the old entries are replaced
