...
public class TestAtlasNotificationStringMessage {
    ...
    public void testMessageWithUnicodeCharacters() {
        String unicodeMessage = "Unicode message: 测试消息 🚀 العربية русский";
    ...
    public void testSerializable() {
        // Test that AtlasNotificationStringMessage implements Serializable
    ...
    public void testInheritanceFromBaseMessage() {
        // Test that AtlasNotificationStringMessage extends AtlasNotificationBaseMessage
