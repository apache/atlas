...
public class TestEntityAuditEventV2 {
    ...
    public void testSerializable() {
        // Test that EntityAuditEventV2 implements Serializable
    ...
    public void testClearable() {
        // Test that EntityAuditEventV2 implements Clearable
        auditEvent.clear();
        assertNull(auditEvent.getEntityId());
        // If this compiles and runs without error, Clearable is implemented
    }
