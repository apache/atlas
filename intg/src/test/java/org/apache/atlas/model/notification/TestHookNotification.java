...
public class TestHookNotification {
    ...
    public void testNormalize() {
        // Test that normalize method exists and can be called
    ...
    public void testSerializable() {
        // Test that HookNotification implements Serializable
    ...
    // Tests for EntityCreateRequestV2 inner class
    @Test
    ...
    // Tests for EntityUpdateRequestV2 inner class
    @Test
    ...
    // Tests for EntityPartialUpdateRequestV2 inner class
    @Test
    ...
    // Tests for EntityDeleteRequestV2 inner class
    @Test
    ...
    public void testInnerClassesJsonAnnotations() {
        // Test that all inner classes have proper Jackson annotations
    ...
    public void testInnerClassesXmlAnnotations() {
        // Test that all inner classes have proper XML annotations
        EntityCreateRequestV2 createRequest = new EntityCreateRequestV2("user", new AtlasEntitiesWithExtInfo());
        EntityUpdateRequestV2 updateRequest = new EntityUpdateRequestV2("user", new AtlasEntitiesWithExtInfo());
        EntityPartialUpdateRequestV2 partialUpdateRequest = new EntityPartialUpdateRequestV2("user", new AtlasObjectId(), new AtlasEntityWithExtInfo());
        EntityDeleteRequestV2 deleteRequest = new EntityDeleteRequestV2("user", new ArrayList<>());
    ...
    public void testCompleteHookNotificationScenario() {
        // Test a complete scenario with all types of requests
    ...
    public void testPrivateConstructors() {
        // Test that private constructors exist (they should not be accessible directly)
        // This is mainly to ensure the inner classes have proper encapsulation
        // We can't directly test private constructors, but we can verify
        // that the public constructors work as expected
        EntityCreateRequestV2 createRequest = new EntityCreateRequestV2("user", new AtlasEntitiesWithExtInfo());
        assertNotNull(createRequest);
