...
public class TestAtlasTermAssignmentHeader {
    ...
    public void testDisplayTextAndQualifiedNameNotIncludedInEquals() {
        // Based on the equals implementation, displayText and qualifiedName are not included
        AtlasTermAssignmentHeader header1 = new AtlasTermAssignmentHeader();
        AtlasTermAssignmentHeader header2 = new AtlasTermAssignmentHeader();
    ...
    public void testDisplayTextAndQualifiedNameNotIncludedInHashCode() {
        // Based on the hashCode implementation, displayText and qualifiedName are not included
        AtlasTermAssignmentHeader header1 = new AtlasTermAssignmentHeader();
        AtlasTermAssignmentHeader header2 = new AtlasTermAssignmentHeader();
    ...
    public void testWithUnicodeCharacters() {
        String unicodeTermGuid = "分配标识符_123";
        String unicodeDescription = "分配描述 with 日本語 and العربية";
        String unicodeExpression = "表达式 🌟";
        String unicodeCreatedBy = "用户@公司.com";
    ...
    public void testHashCodeWithNullValues() {
        ...
        // Both have all null values and default confidence
        assertEquals(header1.hashCode(), header2.hashCode());
    ...
    public void testCompleteScenario() {
        // Create a complete assignment header scenario
        AtlasTermAssignmentHeader header = new AtlasTermAssignmentHeader();
