...
public class TestAsyncImportStatus {
    ...
    public void testParameterizedConstructorWithAllImportStatuses() {
        ...
        // Test with all possible ImportStatus values
    ...
    public void testSpecialCharacters() {
        String specialImportId = "test-import-!@#$%^&*()";
        String specialUser = "user-с-кириллицей-字符";
        String specialTime = "2023-12-01T15:00:00.000Z";
