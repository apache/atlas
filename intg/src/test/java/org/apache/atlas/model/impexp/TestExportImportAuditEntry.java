...
public class TestExportImportAuditEntry {
    ...
    public void testConstantValues() {
        // Test all constant values are defined correctly
    ...
    public void testSpecialCharactersInStrings() {
        ...
        String specialOperation = "CUSTOM_OPERATION_äöü_🌟";
        String specialParams = "param-éñç=value-∑∞√,param2=<>{}[]|\\";
        String specialSourceServer = "source-server-漢字-العربية";
        String specialTargetServer = "target-server-עברית-ελληνικά";
        String specialResultSummary = "Result with special chars: ✓✗⚠️💯";
    ...
    public void testComplexWorkflow() {
        // Simulate a complete export audit entry
