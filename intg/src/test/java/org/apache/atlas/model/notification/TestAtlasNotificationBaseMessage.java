...
public class TestAtlasNotificationBaseMessage {
    ...
    public void testUnicodeStringCompression() {
        String unicodeString = "Hello 世界 🌍 مرحبا";
    ...
    public void testVersionComparison() {
        ...
        assertTrue(baseMessage.compareVersion(version1) > 0); // 1.1.0 > 1.0.0
        assertTrue(baseMessage.compareVersion(version2) == 0); // 1.1.0 == 1.1.0
        assertTrue(baseMessage.compareVersion(version3) < 0); // 1.1.0 < 2.0.0
    }
