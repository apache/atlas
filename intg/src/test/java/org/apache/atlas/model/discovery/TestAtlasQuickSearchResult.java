...
public class TestAtlasQuickSearchResult {
    ...
    public void testCompleteQuickSearchResult() {
        ...
        // Add some sample aggregation metrics
    ...
    public void testSearchResultsIndependence() {
        // Test that search results can be set independently of aggregation metrics
        AtlasSearchResult searchResults = new AtlasSearchResult();
    ...
    public void testAggregationMetricsIndependence() {
        // Test that aggregation metrics can be set independently of search results
        Map<String, List<AtlasAggregationEntry>> aggregationMetrics = new HashMap<>();
    ...
    public void testParameterizedConstructorAssignment() {
        // Test that parameterized constructor properly assigns references
        ...
        Map<String, List<AtlasAggregationEntry>> metrics2 = new HashMap<>();
        ...
        if (searchResults1 != searchResults2) {
            // This check ensures we're testing reference equality correctly
    ...
    public void testMutableAggregationMetrics() {
        // Test that the aggregation metrics map can be modified after setting
        Map<String, List<AtlasAggregationEntry>> aggregationMetrics = new HashMap<>();
        quickSearchResult.setAggregationMetrics(aggregationMetrics);
    ...
    public void testEqualsWithDifferentValues() {
        ...
        // Different AtlasSearchResult instances should make them unequal
    ...
    public void testComplexAggregationMetricsScenario() {
        ...
        // Create multiple aggregation entries for different categories
