...
public class TestAtlasAuditEntry {
    ...
    public void testToString() {
        ...
        // Verify that all fields are included in toString
        // The toString method appends to StringBuilder, so check content
    ...
    public void testSerializable() {
        // Test that AtlasAuditEntry implements Serializable
    ...
    public void testAuditOperationValues() {
        ...
        assertEquals(operations.length, 9);
  ...
  /*  @Test
    public void testAuditOperationToEntityAuditActionV2Export() throws AtlasBaseException {
        EntityAuditEventV2.EntityAuditActionV2 action = AtlasAuditEntry.AuditOperation.EXPORT.toEntityAuditActionV2();
        assertEquals(action, EntityAuditEventV2.EntityAuditActionV2.EXPORT);
    }

    @Test
    public void testAuditOperationToEntityAuditActionV2Import() throws AtlasBaseException {
        EntityAuditEventV2.EntityAuditActionV2 action = AtlasAuditEntry.AuditOperation.IMPORT.toEntityAuditActionV2();
        assertEquals(action, EntityAuditEventV2.EntityAuditActionV2.IMPORT);
    }

    @Test
    public void testAuditOperationToEntityAuditActionV2TypeDefCreate() throws AtlasBaseException {
        EntityAuditEventV2.EntityAuditActionV2 action = AtlasAuditEntry.AuditOperation.TYPE_DEF_CREATE.toEntityAuditActionV2();
        assertEquals(action, EntityAuditEventV2.EntityAuditActionV2.TYPE_DEF_CREATE);
    }*/

    @Test(expectedExceptions = AtlasBaseException.class)
    public void testAuditOperationToEntityAuditActionV2InvalidOperation() throws AtlasBaseException {
        // Create a mock operation that would cause an exception
        // Since we can't create new enum values, we'll test the exception path indirectly
        // by testing with an operation that doesn't have a direct mapping
    ...
    public void testAuditOperationOrdinal() {
        ...
        assertEquals(AtlasAuditEntry.AuditOperation.EXPORT.ordinal(), 1);
        assertEquals(AtlasAuditEntry.AuditOperation.IMPORT.ordinal(), 2);
    }
