...
public class TestAtlasAggregationEntry {
    ...
    public void testGetName() {
        ...
        // Since there's no setName method, we test with parameterized constructor
    ...
    public void testHashCodeEquality() {
        ...
        // Hash code should be same as it's based only on name
    ...
    public void testHashCodeInequality() {
        ...
        // Hash code should be different as names are different
    ...
    public void testEqualsWithSameName() {
        ...
        // Should be equal as equals is based only on name
    ...
    public void testImmutableName() {
        // Test that name cannot be changed after construction (no setter)
        AtlasAggregationEntry entry = new AtlasAggregationEntry("ImmutableName", 100L);

        assertEquals(entry.getName(), "ImmutableName");

        // Verify there's no setName method by trying to change count instead
        entry.setCount(200L);
