...
public class JanusUniqueEdgeKey implements java.io.Serializable {
    ...
    @Id
    @SequenceGenerator(name = "janus_unique_edge_key_seq", sequenceName = "janus_unique_edge_key_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "janus_unique_edge_key_seq")
    @Column(name = "id")
    protected Long id;
