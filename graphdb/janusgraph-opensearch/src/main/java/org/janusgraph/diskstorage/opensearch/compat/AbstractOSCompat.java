...
import static org.janusgraph.diskstorage.opensearch.OpenSearchConstants.OS_ANALYZER;
import static org.janusgraph.diskstorage.opensearch.OpenSearchConstants.OS_ID_KEY;
import static org.janusgraph.diskstorage.opensearch.OpenSearchConstants.OS_LANG_KEY;
import static org.janusgraph.diskstorage.opensearch.OpenSearchConstants.OS_PARAMS_FIELDS_KEY;
import static org.janusgraph.diskstorage.opensearch.OpenSearchConstants.OS_PARAMS_KEY;
import static org.janusgraph.diskstorage.opensearch.OpenSearchConstants.OS_SCRIPT_KEY;
import static org.janusgraph.diskstorage.opensearch.OpenSearchConstants.OS_SOURCE_KEY;
import static org.janusgraph.diskstorage.opensearch.OpenSearchConstants.OS_TYPE_KEY;

/**
 * Base class for building OpenSearch mapping and query objects.
 */
public abstract class AbstractOSCompat {
    ...
    public Map<String,Object> createKeywordMapping() {
        return ImmutableMap.of(OS_TYPE_KEY, "keyword");
    }

    public Map<String,Object> createTextMapping(String textAnalyzer) {
        final ImmutableMap.Builder builder = ImmutableMap.builder().put(OS_TYPE_KEY, "text");
        return (textAnalyzer != null ? builder.put(OS_ANALYZER, textAnalyzer) : builder).build();
    }
    ...
    public ImmutableMap.Builder<String, Object> prepareScript(String source) {
        Map<String, Object> script = ImmutableMap.of(OS_SOURCE_KEY, source,
            OS_LANG_KEY, scriptLang());
        return ImmutableMap.<String, Object>builder().put(OS_SCRIPT_KEY, script);
    }

    public ImmutableMap.Builder<String, Object> prepareStoredScript(String scriptId, List<Map<String, Object>> fields) {
        Map<String, Object> script = ImmutableMap.of(OS_ID_KEY, scriptId,
            OS_PARAMS_KEY, ImmutableMap.of(OS_PARAMS_FIELDS_KEY, fields));
        return ImmutableMap.<String, Object>builder().put(OS_SCRIPT_KEY, script);
    }
