...
public class SSLConfigurationCallback implements HttpClientConfigCallback {
    ...
    public HttpAsyncClientBuilder customizeHttpClient(HttpAsyncClientBuilder httpClientBuilder) {
        ...
        final TrustStrategy trustStrategy = allowSelfSignedCertificates ? TrustSelfSignedStrategy.INSTANCE : null;
        ...
        ClientTlsStrategyBuilder tlsStrategyBuilder = ClientTlsStrategyBuilder.create()
            ...
            .setTlsDetailsFactory((SSLEngine sslEngine) -> new TlsDetails(sslEngine.getSession(), sslEngine.getApplicationProtocol()));
    ...
    public static class Builder {
        ...
        public static Builder create() {
            return new Builder(SSLContextBuilder.create());
        }
