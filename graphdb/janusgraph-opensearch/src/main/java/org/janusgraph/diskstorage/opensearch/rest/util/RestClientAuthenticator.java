 ...
 * JanusGraph OpenSearch REST client to implement a custom authentication method.
 * </p>
 * <p>
 * An implementation must provide a constructor that accepts a String[]. It will receive
 * the value(s) from {@link org.janusgraph.diskstorage.opensearch.OpenSearchIndex#OS_HTTP_AUTHENTICATOR_ARGS}.
