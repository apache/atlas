...
public class AtlasJanusGraphManagementTest {
    ...
    public void testCreateEdgeIndexExistingIndex() {
        ...
        // Should not call buildEdgeIndex if index already exists
    ...
    public void testUpdateSchemaStatusWithException() {
        ...
        try {
            ...
            // Exception in updateSchemaStatus should be handled gracefully
            assertNotNull(e);
        }
    }
    ...
    public void testReindexWithNullIndex() throws Exception {
        ...
        // Should complete without processing when index is null
    }
    ...
    public void testReindexWithNonManagementSystem() throws Exception {
        ...
        // mockJanusManagement is not an instance of ManagementSystem

        List<AtlasElement> elements = new ArrayList<>();
        management.reindex("testIndex", elements);

        // Should complete without processing when management is not ManagementSystem
    }
    ...
    public void testStartIndexRecovery() {
        ...
        try {
            Object result = management.startIndexRecovery(recoveryStartTime);
            // Result can be null or throw exception in test environment - both are acceptable
        } catch (IllegalArgumentException e) {
            // Expected in test environment due to StandardTransactionLogProcessor initialization
    ...
    public void testReindexElementMethod() throws Exception {
        // Create a ManagementSystem mock to test the private reindexElement method
    ...
    public void testIntegrationWithRealGraph() {
        if (atlasGraph != null) {
            try (AtlasGraphManagement mgmt = atlasGraph.getManagementSystem()) {
                ...
                // Test environment may have issues, that's OK
            }
        }
    }
}
