...
public class AtlasJanusDatabaseTest {
    ...
    public <V, E> void testMultiplicityOnePropertySupport() throws Exception {
        ...
        assertEquals(vertex.getProperty("name", String.class), "Jeff");
        assertEquals(vertex.getProperty("location", String.class), "Littleton");

        AtlasVertex<V, E> vertexCopy = graph.getVertex(vertex.getId().toString());

        assertEquals(vertexCopy.getProperty("name", String.class), "Jeff");
        assertEquals(vertexCopy.getProperty("location", String.class), "Littleton");
    ...
    @SafeVarargs
    private final <V, E> void assertEdgesMatch(Iterable<AtlasEdge<V, E>> edgesIt, AtlasEdge<V, E>... expected) {
    ...
    @SafeVarargs
    private final <V, E> void testExecuteGraphQuery(String property, ComparisionOperator op, Object value, AtlasVertex<V, E>... expected) throws Exception {
        AtlasGraph<V, E>      graph = getGraph();
