...
public class ActiveInstanceState {
    ...
    public void update(String serverId) throws AtlasBaseException {
        try {
            ...
            String atlasServerAddress = RestHAConfiguration.getBoundAddressForId(configuration, serverId);
    ...
    private String getZnodePath(RestHAConfiguration.ZookeeperProperties zookeeperProperties) {
