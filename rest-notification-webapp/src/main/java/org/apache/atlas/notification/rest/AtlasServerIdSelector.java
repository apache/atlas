...
public class AtlasServerIdSelector {
     ...
     *
     * The match is done by looking for an ID configured in {@link RestHAConfiguration #ATLAS_SERVER_IDS} key
     * that has a host:port entry for the key {@link RestHAConfiguration #ATLAS_SERVER_ADDRESS_PREFIX}+ID where
