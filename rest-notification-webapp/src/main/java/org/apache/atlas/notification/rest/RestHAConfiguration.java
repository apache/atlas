...
public final class RestHAConfiguration {
    ...
    public static final String ATLAS_REST_SERVER_HA_PREFIX                = "atlas.rest.server.ha.";
    public static final String ZOOKEEPER_PREFIX                           = "zookeeper.";
    public static final String ATLAS_REST_SERVER_HA_ZK_ROOT_KEY           = ATLAS_REST_SERVER_HA_PREFIX + ZOOKEEPER_PREFIX + "zkroot";
    public static final String ATLAS_REST_SERVER_HA_ENABLED_KEY           = ATLAS_REST_SERVER_HA_PREFIX + "enabled";
    public static final String ATLAS_REST_SERVER_ADDRESS_PREFIX           = "atlas.rest.server.address.";
    public static final String ATLAS_REST_SERVER_IDS                      = "atlas.rest.server.ids";
    public static final String HA_ZOOKEEPER_CONNECT                       = ATLAS_REST_SERVER_HA_PREFIX + ZOOKEEPER_PREFIX + "connect";
    ...
    public static final String HA_ZOOKEEPER_RETRY_SLEEPTIME_MILLIS        =
            ATLAS_REST_SERVER_HA_PREFIX + ZOOKEEPER_PREFIX + "retry.sleeptime.ms";
    public static final String HA_ZOOKEEPER_NUM_RETRIES                   = ATLAS_REST_SERVER_HA_PREFIX + ZOOKEEPER_PREFIX + "num.retries";
    ...
    public static final String HA_ZOOKEEPER_SESSION_TIMEOUT_MS            =
            ATLAS_REST_SERVER_HA_PREFIX + ZOOKEEPER_PREFIX + "session.timeout.ms";
    public static final int    DEFAULT_ZOOKEEPER_SESSION_TIMEOUT_MILLIS   = 20000;
    public static final String HA_ZOOKEEPER_ACL                           = ATLAS_REST_SERVER_HA_PREFIX + ZOOKEEPER_PREFIX + "acl";
    public static final String HA_ZOOKEEPER_AUTH                          = ATLAS_REST_SERVER_HA_PREFIX + ZOOKEEPER_PREFIX + "auth";
    ...
    public static boolean isHAEnabled(Configuration configuration) {
        ...
        if (configuration.containsKey(RestHAConfiguration.ATLAS_REST_SERVER_HA_ENABLED_KEY)) {
            ret = configuration.getBoolean(ATLAS_REST_SERVER_HA_ENABLED_KEY);
        } else {
            String[] ids = configuration.getStringArray(RestHAConfiguration.ATLAS_REST_SERVER_IDS);
    ...
    public static List<String> getServerInstances(Configuration configuration) {
        String[] serverIds = configuration.getStringArray(ATLAS_REST_SERVER_IDS);
    ...
    public static ZookeeperProperties getZookeeperProperties(Configuration configuration) {
        ...
        String zkRoot = configuration.getString(ATLAS_REST_SERVER_HA_ZK_ROOT_KEY, ATLAS_REST_SERVER_ZK_ROOT_DEFAULT);
