...
public class KafkaNotificationMockTest {
    ...
    // scenario 6: detect a drained import topic so a PROCESSING import on it can be resolved instead
    // of holding the import claim forever.
    @Test
    ...
    public void testIsTopicFullyConsumedWhenTopicNoLongerExists() {
        ...
        // a deleted topic cannot deliver anything, so the import must not be left holding the claim
